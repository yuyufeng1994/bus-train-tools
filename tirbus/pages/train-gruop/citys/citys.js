Page({
  ...
  citySelected: function (e) {
    ...
    if (this.data.begin == null || this.data.begin.trim() == "") {
      this.setData({ begin: cityNameTemp })
    }

    if (this.data.end == null || this.data.end.trim() == "") {
      this.setData({ end: cityNameTemp })
    }

    wx.redirectTo({
      url: '../train/train?begin=' + this.data.begin + '&end=' + this.data.end + '&date=' + this.data.date,
    })
  },
